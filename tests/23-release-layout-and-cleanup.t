...
my $release = File::Spec->catdir($prefix, 'releases', '2026.08.1-rc2');
...
is($marker->{version}, '2026.08.1-rc2', 'managed release marker records version');
...
is($metadata->{version}, '2026.08.1-rc2', 'wrapper metadata identifies release');
...
is($managed_marker->{version}, '2026.08.1-rc2', 'managed release marker is returned');
