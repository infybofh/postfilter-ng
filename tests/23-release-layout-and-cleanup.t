...
my $release = File::Spec->catdir($prefix, 'releases', '2026.07.5-rc7');
...
is($marker->{version}, '2026.07.5-rc7', 'managed release marker records version');
...
is($metadata->{version}, '2026.07.5-rc7', 'wrapper metadata identifies release');
...
is($managed_marker->{version}, '2026.07.5-rc7', 'managed release marker is returned');
