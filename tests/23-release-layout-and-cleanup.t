...
my $release = File::Spec->catdir($prefix, 'releases', '2026.07.5-rc6');
...
is($marker->{version}, '2026.07.5-rc6', 'managed release marker records version');
...
is($metadata->{version}, '2026.07.5-rc6', 'wrapper metadata identifies release');
...
is($managed_marker->{version}, '2026.07.5-rc6', 'managed release marker is returned');
