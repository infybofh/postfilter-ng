...
my $release = File::Spec->catdir($prefix, 'releases', '2026.09.1-rc1');
...
is($marker->{version}, '2026.09.1-rc1', 'managed release marker records version');
...
is($metadata->{version}, '2026.09.1-rc1', 'wrapper metadata identifies release');
...
is($managed_marker->{version}, '2026.09.1-rc1', 'managed release marker is returned');
